...
public class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
	...
	private lazy var collectionViewLayout: AKCollectionViewLayout = {
	...
	*/
	private func sizeForString(string: NSString) -> CGSize {
        let size = string.sizeWithAttributes([NSFontAttributeName: self.font, NSKernAttributeName: self.kerning])
        let highlightedSize = string.sizeWithAttributes([NSFontAttributeName: self.highlightedFont, NSKernAttributeName: self.kerning])
		return CGSize(
	...
	*/
	...
	public func collectionView(collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAtIndexPath indexPath: NSIndexPath) -> CGSize {
        ...
        if self.collectionViewLayout.scrollDirection == .Horizontal {
            ...
            var size = CGSizeMake(maxWidth, self.interitemSpacing)
            if let title = self.dataSource?.pickerView?(self, titleForItem: indexPath.item) {
